...
public class Teclado {
	...
	public static char leerChar(){
		...
		do {
			cadena = teclado.next();
			if (cadena.length()>1)
				System.out.print("- Introduzca sï¿½lo un caracter: ");
			else
		...
		do{
			...
			if (cadena.length()>1)
				...
				if (cadena.matches(patron)){
					...
					System.out.print("El caracter no cumple el patrï¿½n: ");
					repetir = true;
				}
	...
	public static String leerLineaPatron(String patron){
		...
		do {
			...
			if (!cadena.matches(patron))
				System.out.print("La cadena no cumple el patrï¿½n: ");
	...
	public static int leerInt(){
		...
		do{
			try{
				...
				System.out.print("-  Debe introducir un nï¿½mero: ");
				error = true;
			}finally{
				teclado.nextLine();
			}
